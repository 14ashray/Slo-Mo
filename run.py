...
for strOption, strArgument in getopt.getopt(sys.argv[1:], '', [ strParameter[2:] + '=' for strParameter in sys.argv[1::2] ])[0]:
	...
	if strOption == '--padding' and strArgument != '': arguments_strPadding = strArgument
	if strOption == '--first' and strArgument != '': arguments_strFirst = strArgument
	if strOption == '--second' and strArgument != '': arguments_strSecond = strArgument
	if strOption == '--video' and strArgument != '': arguments_strVideo = strArgument
